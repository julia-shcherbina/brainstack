...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Task.number'
        db.alter_column(u'core_task', 'number', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Task.number'
        raise RuntimeError("Cannot reverse this migration. 'Task.number' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Task.number'
        db.alter_column(u'core_task', 'number', self.gf('django.db.models.fields.PositiveIntegerField')())
