...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_task', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.UserProfile']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Task.created_by'
        db.alter_column(u'core_task', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.UserProfile']))
    ...
    models = {
        ...
        'core.task': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'created_task'", 'null': 'True', 'to': "orm['core.UserProfile']"}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
